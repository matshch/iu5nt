...
namespace iu5nt
{
  public partial class MainWindow : Window, IDisposable
  {
    ...
    private void SendFile_Click(object sender, RoutedEventArgs e)
    {
      ...
      {
        MessageBox.Show(
          "Принимающая сторона не готова к логическому соединению.");
        return;
      }
    ...
    {
      Dispatcher.Invoke(new DataLink.RecieveMEthod(ReceiveMessage),
        DispatcherPriority.Send, packet, check);
    }
    ...
    {
      Dispatcher.Invoke(new Physical.PortListener(RealPortCheck),
        DispatcherPriority.Send, DSR, CTS, DTR, RTS);
    }
    ...
    private void ExceptionHandler(object sender,
    ...
    {
      FileName, ReceiveNotReady, FileRequest, FileChunk,
      FileReceived, FileReceivedOk, Disconnect, DisconnectOk
    }
  }
}
